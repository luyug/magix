...
class FlaxGemmaMLP(nn.Module):
    ...
    def __call__(self, hidden_states):
        ...
        up_proj_states = lax.with_sharding_constraint(
            up_proj_states, PS('data', None, 'model'))
        gate_states = lax.with_sharding_constraint(
            gate_states, PS('data', None, 'model'))
