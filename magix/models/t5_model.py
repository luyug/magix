...
class FlaxT5PreTrainedModel(FlaxPreTrainedModel):
    ...
    partition_rules = {
        '(wi|wi_0|wi_1)/kernel': PS('data', 'model'),
        'wo/kernel': PS('model', 'data'),
        '(SelfAttention|EncDecAttention)/(q|k|v)/kernel': PS('data', 'model'),
        '(SelfAttention|EncDecAttention)/o/kernel': PS('model', 'data'),
        'shared/embedding': PS('data', 'model'),
        'lm_head/kernel': PS('model', 'data'),
    }
